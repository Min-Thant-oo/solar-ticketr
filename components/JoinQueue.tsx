...
const JoinQueue = ({ 
    ...
    const availablity = useQuery(api.events.getEventAvailability, { eventId });
    ...
    if(queuePosition === undefined || availablity === undefined || !event) {
        return <Spinner />
    }
            ...
            {(!queuePosition || 
                ...
                <>
                    {isEventOwner ? (
                        ...
                        ) : availablity.purchasedCount >= availablity?.totalTickets ? (
                            <div className="text-center p-4">
                                <p className="text-lg font-sembold text-red-600">
