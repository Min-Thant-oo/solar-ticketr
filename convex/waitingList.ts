...
// Muration to process the waiting list queue and offer tickets to next eligible users.
...
export const processQueue = mutation({
    ...
    handler: async (ctx, { eventId }) => {
      ...
      const waitingUsers = await ctx.db
        ...
        .order("asc")
        .take(availableSpots);  // if the availespots is 3, this will take 3 waiting users
